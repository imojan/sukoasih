...
$query = mysqli_query($koneksi, "SELECT id_dokter FROM tb_dokter ORDER BY id_dokter DESC LIMIT 1");
$data_kode = mysqli_fetch_assoc($query);

$no_akhir = (isset($data_kode['id_dokter'])) ? (int)substr($data_kode['id_dokter'], -3) : 0;
$no_baru = $no_akhir + 1;
$kode_baru = str_pad($no_baru, 3, "0", STR_PAD_LEFT);
$id_dokter_baru = "D" . $kode_baru;
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="">
                                <form class="ml-4" method="post" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="id_dokter" value="<?= $id_dokter_baru; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            <label>Nama Dokter</label>
                                            <input type="text" class="form-control" name="nm_dokter" placeholder="Nama + Gelar"required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="telp_dokter" required>
                                        </div>
                                    </div>
                                ...
                                if (isset($_POST['save'])) {
                                        // Insert data
                                        $koneksi->query("INSERT INTO tb_dokter (nm_dokter, id_poli, telp_dokter) 
                                        VALUES ('$_POST[nm_dokter]', '$_POST[id_poli]', '$_POST[telp_dokter]')");

                                        $id_dokter = $koneksi->insert_id;
                                        $formatted_id_dokter = str_pad($id_dokter, 3, '0', STR_PAD_LEFT);

                                        echo "<script>alert('Data Tersimpan! ID Dokter: D$formatted_id_dokter');</script>";
