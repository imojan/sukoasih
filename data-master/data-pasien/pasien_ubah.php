...
$ambil = $koneksi->query("SELECT * FROM tb_pasien WHERE no_rm='$_GET[no_rm]'");
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="">
                                <form class="ml-4" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            value="<?= htmlspecialchars($pecah['nik']) ?>"
                                            minlength="16" maxlength="16"
                                            pattern="\d{16}"
                                            required title="NIK harus 16 digit angka.">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            <select class="custom-select" name="jenis_kelamin" required>
                                                <option value="" disabled <?= empty($pecah['jenis_kelamin']) ? 'selected' : '' ?>>Pilih Jenis Kelamin</option>
                                                <option value="Laki-laki" <?= $pecah['jenis_kelamin'] == 'Laki-laki' ? 'selected' : '' ?>>Laki-laki</option>
                                                <option value="Perempuan" <?= $pecah['jenis_kelamin'] == 'Perempuan' ? 'selected' : '' ?>>Perempuan</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="telp_psn" value = "<?php echo $pecah['telp_psn'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            <label>Alergi Obat</label>
                                            <textarea class="form-control" name="alergi_obat" rows="3" required><?php echo $pecah['alergi_obat'] ?></textarea>
                                        </div>
                                    </div>                        
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            <label>Nama Penanggung Jawab</label>
                                            <input type="text" class="form-control" name="nm_pj" value="<?php echo $pecah['nm_pj'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            <label>Telepon Penanggung Jawab</label>
                                            <input type="text" class="form-control" name="telp_pj" value= "<?php echo $pecah['telp_pj'] ?>" required>
                                        </div>
                                    </div>
                                ...
                                <?php
                                if (isset($_POST['ubah'])) {
                                    $koneksi->query("UPDATE tb_pasien SET no_rm= CONCAT(LPAD(no_rm, 6, '0')), nik='$_POST[nik]', nm_pasien='$_POST[nm_pasien]', jenis_kelamin='$_POST[jenis_kelamin]', 
                                        tgl_lahir='$_POST[tgl_lahir]', alamat='$_POST[alamat]', telp_psn='$_POST[telp_psn]', alergi_obat='$_POST[alergi_obat]', nm_pj='$_POST[nm_pj]', telp_pj='$_POST[telp_pj]'
