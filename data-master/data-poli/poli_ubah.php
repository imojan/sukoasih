        ...
        <div id="layoutSidenav_content" class="bg-white text-dark">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Ubah Data Poliklinik</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="../../index.php" class="text-decoration-none">Dashboard</a></li>
                        <li class="breadcrumb-item active">Data Master</li>
                        <li class="breadcrumb-item active">Data Poliklinik</li>
                        <li class="breadcrumb-item active">Ubah Data Poliklinik</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header font-weight-bold">
                            Data Poliklinik : <?php echo $pecah['nm_poli']; ?>
                        </div>
                        <div class="card-body">
                            <div class="">
                                <form class="ml-4" method="post" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="id_poli" value="<?php echo 'P' . str_pad($pecah['id_poli'], 3, '0', STR_PAD_LEFT); ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            <label>Nama Poliklinik</label>
                                            <input type="text" class="form-control" name="nm_poli" value="<?php echo $pecah['nm_poli'] ?>" required>
                                        </div>
                                    </div>
                                ...
                                <?php
                                if (isset($_POST['ubah'])) {
                                    $koneksi->query("UPDATE tb_poli SET nm_poli='$_POST[nm_poli]' WHERE id_poli='$_GET[id_poli]'");

                                    echo "<script>alert('Data Poliklinik Telah Diubah!');</script>";
