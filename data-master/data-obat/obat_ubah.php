                            ...
                            <div class="">
                                <form class="ml-4" method="post" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            <label>ID Obat</label>
                                            <input type="text" class="form-control" name="id_obat" value="<?php echo 'O' . str_pad ($pecah['id_obat'], 3, '0', STR_PAD_LEFT) ; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            <select class="custom-select" name="bentuk_obat">
                                                <option value="<?php echo $pecah['bentuk_obat']; ?>"><?php echo $pecah['bentuk_obat']; ?></option>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="stok_obat" value="<?php echo $pecah['stok_obat']; ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                ...
                                <?php
                                if (isset($_POST['ubah'])) {
                                    $koneksi->query("UPDATE tb_obat SET id_obat= CONCAT(LPAD(id_obat, 3, '0')), nm_obat='$_POST[nm_obat]', bentuk_obat='$_POST[bentuk_obat]', 
                                        stok_obat='$_POST[stok_obat]', exp_obat='$_POST[exp_obat]'
