...
if ($id_pemeriksaan != '') {
    ...
    $tanggal = date('d-m-Y', strtotime($pecah['tgl_pemeriksaan']));
    ...
    if ($id_poli === '3') {
        ...
        $pemeriksaan_detail = [
            ...
            'keterangan' => $pecah['anamnesa'] ?? '',
            'tindak_lanjut' => $pecah['tindak_kb'] ?? '',
        ];
    } elseif ($id_poli === '4' && $jenis_kia === 'Imunisasi') {
        $pemeriksaan_detail = [
            'jenis_imunisasi' => $pecah['jenis_imunisasi'] ?? '',
            'tgl_imunisasi' => $pecah['tgl_imunisasi'] ?? '',
                                ...
                                <form class="ml-4" method="post" class="pemeriksaan" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" id="id_pemeriksaan" name="id_pemeriksaan" value="<?php echo $pecah['id_pemeriksaan']; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="nm_pj" value="<?php echo $pecah['nm_pj']; ?>" id="nm_pj" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Riwayat Penyakit Pasien</label>
                                        <textarea name="riwayat_penyakit" class="form-control" rows="3" <?php echo $pecah['riwayat_penyakit']; ?> readonly></textarea>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <label>Tanggal Pemeriksaan</label>
                                            <input type="text" class="form-control" name="tgl_pemeriksaan" value="<?php echo $tanggal ?>" id="tgl_pemeriksaan" readonly>
                                        </div>
                                        <div class="col-sm-6">
                                            <label>Petugas</label>
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-header">Screening Poli <strong><?= ucfirst($nm_poli) ?></strong></div>
                                        <div class="card-body">                                            
                                            <?php if ($id_poli == '2'): ?>
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Keluhan</label>
                                                    <textarea name="keluhan_umum" class="form-control" rows="3" value="<?php echo $pecah['keluhan_umum']; ?>" readonly></textarea>
                                                </div>
                                            <?php elseif ($id_poli == '1'): ?>
                                                ...
                                                <div class="form-group">
                                                    <label>Keluhan</label>
                                                    <textarea name="keluhan_obgyn" class="form-control" rows="3" value="<?php echo $pecah['keluhan_obgyn']; ?>" readonly></textarea>
                                                </div>
                                                    ...
                                                    <?php elseif ($jenis_kia == 'KB'): ?>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-6">
                                                                ...
                                                                <input type="text" class="form-control" name="jenis_kb" value="<?php echo $pecah['jenis_kelamin'] ?>" readonly>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label>Tanggal Pertama Pemasangan</label>
                                                                <input type="date" name="tgl_pasang" class="form-control" value="<?php echo $pecah['jenis_kelamin'] ?>" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Anamnesa</label>
                                                            <textarea name="anamnesa" class="form-control" rows="3" value="<?php echo $pecah['anamnesa']; ?>" readonly>/textarea>
                                                        </div>
                                            ...
                                            <?php else: ?>
                                                <div class="alert alert-warning">
                                                    <strong>Poli "<?= $nm_poli ?>" belum didukung.</strong><br>
                                        ...
                                        <div class="card-body">
                                            <?php if ($id_poli === '3'): ?>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea class="form-control" readonly><?= $pemeriksaan_detail['S'] ?? '' ?></textarea>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>Objective</label>
                                                        <textarea class="form-control" readonly><?= $pemeriksaan_detail['O'] ?? '' ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label>Assessment</label>
                                                        <textarea class="form-control" readonly><?= $pemeriksaan_detail['A'] ?? '' ?></textarea>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>Plan</label>
                                                        <textarea class="form-control" readonly><?= $pemeriksaan_detail['P'] ?? '' ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-2">
                                                        <label>Kode ICD-10</label>
                                                        <input type="text" class="form-control" readonly value="<?= $pemeriksaan_detail['kd_diagnosa'] ?? '' ?>">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>Tindak Lanjut</label>
                                                        <input type="text" class="form-control" readonly value="<?= $pemeriksaan_detail['tindak_lanjut'] ?? '' ?>">
                                                    </div>
                                                </div>
                                            ...
                                            <?php elseif (in_array($id_poli, ['1', '2', '4']) && $jenis_kia !== 'Imunisasi'): ?>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-5">
                                                        ...
                                                        <textarea class="form-control" readonly><?= $pemeriksaan_detail['diagnosa'] ?? '' ?></textarea>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        <label><?= ($jenis_kia === 'KB') ? 'Anamnesa / Keterangan' : 'Terapi' ?></label>
                                                        <textarea class="form-control" readonly><?= $pemeriksaan_detail['terapi'] ?? $pemeriksaan_detail['keterangan'] ?? '' ?></textarea>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>Tindak Lanjut</label>
                                                        <input type="text" class="form-control" readonly value="<?= $pemeriksaan_detail['tindak_lanjut'] ?? '' ?>">
                                            ...
                                            <?php elseif ($id_poli === '4' && $jenis_kia === 'Imunisasi'): ?>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        <label>Terapi</label>
                                                        <textarea class="form-control" readonly><?= $pemeriksaan_detail['terapi'] ?? '' ?></textarea>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>Tindak Lanjut</label>
                                                        <input type="text" class="form-control" readonly value="<?= $pemeriksaan_detail['tindak_lanjut'] ?? '' ?>">
